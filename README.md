...
- Clone the github repository
  ```shell
  $ git clone https://github.com/pankaj8blr/Semantic-Spotter-Project
  ```
- Open
  the [notebook](https://github.com/pankaj8blr/Semantic-Spotter-Project/semantic-spotter-langchain-notebook.ipynb)
